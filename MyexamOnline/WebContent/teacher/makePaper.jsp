		...
		<div class="row clearfix">
				...
				<div class="container-fluid">
					...
					<div>
						<ul class="nav navbar-nav">
							...
							<li Class="active"><a href="makePaper.jsp">发布试卷</a></li>
			...
			<div class="col-md-4 col-md-offset-4">
				...
				<form action="../MakePaper" method="post">
					...
					<div style="position:absolute; left:32px; top:200px;">
						<label><font color="white">结束时间：</font></label>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="endtime" type="text" readonly class="form_datetime"/>
					</div>
					
					<div style="position:absolute; left:32px; top:230px;">
						<label><font color="white">试卷名：</font></label>
