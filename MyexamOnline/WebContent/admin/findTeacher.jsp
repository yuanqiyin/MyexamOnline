...
<span style="color:red;font-size: 20px">*如果删除或修改教师，与该教师相关的信息（如该教师发布的试卷、试卷的成绩、错题等）也会做出相应的删除或者修改</span>
...
function values(subjectid) {  
    ...
    //var age = document.getElementById("table").rows[id].cells[3].innerText;
    var pwd = document.getElementById("table").rows[id].cells[3].innerText;
    ...
    var birthdate = document.getElementById("table").rows[id].cells[4].innerText;
    var email = document.getElementById("table").rows[id].cells[7].innerText;
