...
<body>
	<div class="container">
		<div class="row clearfix">
					...
					<div>
						<ul class="nav navbar-nav">
							...
							<li class="dropdown active"><a href="#"
								class="dropdown-toggle" data-toggle="dropdown">学生管理<strong
			...
			<font size="6" color="red">批量添加</font></div>
			<div align="center">
			...
			<div class="col-md-6 col-md-offset-3">
				<h1 class="page-header text-center">
					<font color="white">学生添加</font>
				</h1>
				<form class="form-horizontal" role="form"
					action="../ManagementStudent?method=addStudent" method="post">
					<div class="form-group">
						<label for="lastname" class="col-sm-2 control-label"><font
							color="white">学号</font></label>
						<div class="col-sm-10">
