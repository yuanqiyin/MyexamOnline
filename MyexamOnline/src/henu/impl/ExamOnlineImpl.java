...
public class ExamOnlineImpl implements ExamOnlineIF{
	...
	public boolean addStuAnswer(StuAnswer sa) {
		String sql = "INSERT INTO stuanswer (paperid,sid,"
				+ "sa_answer1,sa_answer2)"
				+ "VALUES (?,?,?,?)";
		PreparedStatement ps = DbcpPool.executePreparedStatement(sql);
		int result = 0 ;
		try {
			ps.setInt(1, sa.getPaperid());
			ps.setInt(2, sa.getSid());
			ps.setString(3, sa.getSa_answer1());
			ps.setString(4, sa.getSa_answer2());
