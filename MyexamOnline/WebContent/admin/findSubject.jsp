...
<span style="color:red;font-size: 20px">*如果删除或修改学科，与该学科相关的信息（如该学科的试题、试卷、成绩和错题等）也会做出相应的删除或者修改</span>
...
<%if (record == null || record.size() == 0) {
   ...
   <tr  class="success">
     ...
     <td><%=r.getSubjectteacher() %></td>
     <td><%=r.getSubjectterm() %></td>   
     <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">修改学科</h4>
            </div>
            ...
            <input type="hidden" name="subjectid" id="subjectid" /> 
                ...
                授课老师：<input type="text" name="subjectteacher" id="subjectteacher" /><br>
                授课学期：<input type="text" name="subjectterm" id="subjectterm" /><br>
            </div>
...
function values(subjectid) {  
    ...
    var subjectteacher = document.getElementById("table").rows[id].cells[2].innerText;
    var subjectterm = document.getElementById("table").rows[id].cells[3].innerText;
    //向模态框中传值  
    document.getElementById("subjectid").value = sid;
    document.getElementById("subjectname").value = subjectname;
    document.getElementById("subjectteacher").value = subjectteacher;
    document.getElementById("subjectterm").value = subjectterm;
}  
</script>
</body>
</html>